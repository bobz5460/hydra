...
A deployable self-host backend starter (API, auth callback page, and WebSocket service) is available at `./backend`.
See `./backend/README.md` for setup and Docker Compose usage.
